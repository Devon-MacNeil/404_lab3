...
public class TextDBResultSet implements ResultSet {
	...
	private String[] columnNames; // Names of each column (should be first row
									// in file)
	private TextDBResultSetMetaData metadata; // Metadata description of
												// ResultSet

	public TextDBResultSet(String result) { // TODO: Complete this method.
											// Parse all results into an
											// ArrayList for easier retrieval
											// First row is the row of column
											// names
											// Set up result rows
		...
		try {
			...
			//reads each line in the string and adds it to the arraylist
			String line = reader.readLine();
			while (line != null) {
				results.add(line);
				line = reader.readLine();
			}
			// get the column names from the results arraylist
			col = results.get(0);

			//split the string of column names and insert each column into the array
			// t because tab delineated
			columnNames = col.split("\\t+");
	...
	public boolean next() throws SQLException {
		...
		//check if the currentLoc is a valid index
	...
	public Object getObject(int idx) throws SQLException {
		...
		if (idx < 1 || idx > columnNames.length)
			throw new SQLException("Invalid column index.");
		//returns the object in the columns array at the given index
	...
	public Object getObject(String name) throws SQLException {
		// TODO: Complete this method.
		//finds the index for the object
		int col = findColumn(name);
	...
	/**
	 * Returns column index (starting at 1) if column name is found. Throws an
	 * SQLException otherwise.
	 * 
	 * @param name
	 * @return
	 */
